                            ...
                            width: "64px",
                                ...
                                animation: "checkAppear 0.3s ease-out 0.3s both",
                                    ...
                                    : showContinueWithTx
                                        ...
                                        : "Your payment has been completed successfully." })] })] }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "3xl" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "sm", style: { width: "100%" }, children: [(0, jsx_runtime_1.jsx)(buttons_js_1.Button, { fullWidth: true, onClick: () => setViewState("detail"), variant: "secondary", children: "View Payment Receipt" }), !hasPaymentId && ((0, jsx_runtime_1.jsx)(buttons_js_1.Button, { fullWidth: true, onClick: onDone, variant: "accent", children: showContinueWithTx ? "Continue" : "Done" }))] }), (0, jsx_runtime_1.jsx)("style", { children: `
